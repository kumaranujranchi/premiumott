...
$stats = [
    ...
    'revenue' => $pdo->query("SELECT SUM(total_amount) FROM orders WHERE status = 'Processed'")->fetchColumn() ?: 0
];
...
<head>
    ...
    <style>
        :root { --primary: #3DFE02; --bg: #F9FAFB; --card: #FFFFFF; --text: #111827; --border: #E5E7EB; }
        ...
        .stat-value { font-size: 24px; font-weight: 700; margin-top: 8px; color: var(--text); }
        ...
        th { background: #F3F4F6; font-size: 13px; font-weight: 600; color: #6B7280; text-transform: uppercase; }
        ...
        .btn { padding: 6px 12px; border-radius: 6px; font-size: 13px; font-weight: 600; text-decoration: none; cursor: pointer; border: none; }
        .btn-process { background: var(--primary); color: #000; }
        .nav-links { display: flex; gap: 20px; }
        .nav-links a { text-decoration: none; color: #6B7280; font-weight: 600; }
                    ...
                    <?php foreach ($orders as $o): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="font-size: 12px; color: #6B7280;"><?php echo htmlspecialchars($o['customer_email']); ?></div>
                            </td>
                            <td>
                                <div><a href="https://wa.me/<?php echo preg_replace('/[^0-9]/', '', $o['customer_whatsapp']); ?>" target="_blank" style="color: #25D366; text-decoration: none; font-weight: 600;">WhatsApp</a></div>
                            </td>
                            <td>
                            ...
                            <td>
                                <?php if ($o['status'] == 'Pending'): ?>
                                    <a href="?id=<?php echo $o['id']; ?>&status=Processed" class="btn btn-process">Mark Processed</a>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
